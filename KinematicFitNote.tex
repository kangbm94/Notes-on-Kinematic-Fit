...
\begin{frame}{Pull distribution}
	\begin{block}{}
		A bias or resolution miss-estimation is revealed by observing the \textit{Pull distribution} of each measurements. By defining the residual $\epsilon = m-m^0$ and its variance $V(\epsilon)$, the pull is defined as:
		\begin{align}
...
\end{block}
	}
	{
		...
		\begin{picture}(200,200)
			\put(0,10){\includegraphics[width = .75\textwidth]{XiRestore}}
			\put(75,160){\large $\Xi^-$}	
